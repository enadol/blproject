...
print("Creating JSON output on tablavoll18.json...")
...
fhand = open('../json/tablavoll18.json','w')
nodes = list()
...
#tablalocal
fhand = open('../json/tablalocal18.json','w')
nodes = list()
...
#tablavisitante
fhand = open('../json/tablavisitante18.json','w')
nodes = list()
